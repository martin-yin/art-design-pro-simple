...
<template>
  <div class="layout-sidebar" v-if="showLeftMenu || isDualMenu">
        ...
        <ul>
          <li v-for="menu in firstLevelMenus" :key="menu.path" @click="handleMenuJump(menu, true)">
            ...
            >
              <div
                :class="{
                  'is-active': menu.meta.isInMainContainer ? menu.path === route.path : menu.path === firstLevelMenuPath
                }"
                :style="{
    ...
    >
      ...
      >
        <SidebarSubmenu :list="menuList" :isMobile="isMobileModel" :theme="getMenuTheme" @close="closeMenu" />
      </el-menu>
